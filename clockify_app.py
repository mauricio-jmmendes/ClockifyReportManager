...
(PDF or Excel) into formatted Excel reports. The Summary sheet is automatically
generated by aggregating data from the Detailed report.
"""
...
def find_detailed_file():
    ...
    """
    # Search for Detailed file (PDF preferred, Excel supported for legacy exports)
    detailed_files = []
    for pattern in (
        os.path.join(APP_DIR, "Clockify_Time_Report_Detailed_*.pdf"),
        os.path.join(APP_DIR, "Clockify_Time_Report_Detailed_*.xlsx"),
    ):
